...
const recentPostTitle = css`
  text-decoration: none;
  color: white;
`;

const PageLayout: FunctionComponent<{ pageData: any }> = ({
  children,
  pageData
}) => (
  <React.Fragment>
    ...
    >
      <Row>
        <Column>
          <large>We are here</large>
          <br></br>
          <p>
            <small> Zion Hill</small>
            <br></br>
            <small> Fairy Hill PO</small>
            <br></br>
