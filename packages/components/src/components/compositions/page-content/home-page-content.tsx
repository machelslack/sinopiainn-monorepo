...
import { TwoColumnRow, Column, Row } from "../../../layouts/row";
import {
  SlideShowContainer,
  SlideShowSlide,
  SlideShowDots
...
const listItems = [
  ...
  },
  {
    ...
    subtitle:
      "Free wireless internet access in guest rooms, meeting spaces and lounge "
  },
  {
    title: "Outdoor Deck And Jerk Pit",
    subtitle:
      "Sit back and relax with views of the cool countryside and a jerk pit ready and wood-stocked perfect for entertaining family and friends during your stay"
  },
  {
...
const firstRowLeftcolumn = (
  <React.Fragment>
    ...
    <p css={paragraph}>
      {" "}
      Set on two acres of lush green gardens, less than a stone’s throw away
      from Dragon Bay, location of Tom Cruise’s iconic Cocktail movie, you
      <span
        css={css`
           {
            font-family: Arial;
      ...
      ll quickly understand why Hollywood came calling. And you'll see why the
      entire villa is the perfect holiday de-stress HQ for families. There is
      air-conditioning in all suites of Sinopia Inn, and the coolness of the
      entire home will present a welcome respite to the heat.
    </p>{" "}
  </React.Fragment>
);

const firstRowRightcolumn = (
  <SlideShowContainer slideNumber={0}>
    {slideshowImages.map(src => (
      <SlideShowSlide imgSrc={src} slideNumber={1} />
    ))}
    {/* <SlideShowDots /> */}
  </SlideShowContainer>
);
...
const secondRowLeftcolumn = (
  <SlideShowContainer slideNumber={1}>
    {roomsSlideShowImages.map(imgsrc => (
      <SlideShowSlide imgSrc={imgsrc} slideNumber={2} />
    ))}
    {/* <SlideShowDots /> */}
  </SlideShowContainer>
);
...
const secondRowRightcolumn = (
  <React.Fragment>
    <h1> OUR ROOMS</h1>{" "}
    <p css={paragraph}>
      We offer 2 family sized air conditioned en suite bedrooms and 2 double
      occupancy en suite bedrooms, with modern interior decor that still evokes
      a feeling of Jamaica’s mid{" "}
      <span
        css={css`
           {
            font-family: Arial;
      ...
      19th century heyday. The abundance of palm trees and other Jamaican flora
      make it a stunning hideaway in Portland, Jamaica. These units are perfect
      for all types{" "}
      <span
        css={css`
           {
      ...
      what many call the natural parish of Jamaica. Here you are able to
      experience tranquil nights and great accommodation alternatives to the
      resort locations of Montego Bay, Ocho Rios and Negril We like to think of
      our home as Jamaica East’s best
      <span
        css={css`
           {
            font-family: Arial;
      ...
      kept secret. And home to some of Jamaica's best positive alternative
      experiences - its cool countryside, hidden beaches, falls and its vibrant
      local culture.
    </p>{" "}
  </React.Fragment>
);
...
const thirdRowRightcolumn = (
  <SlideShowContainer slideNumber={2}>
    {amenitiesSlideShowImages.map(imgsrc => (
      <SlideShowSlide imgSrc={imgsrc} slideNumber={3} />
    ))}
    {/* <SlideShowDots /> */}
  </SlideShowContainer>
);

const thirdRowLeftcolumn = (
  <React.Fragment>
    <h1> THINGS TO DO </h1>{" "}
    <p css={paragraph}>
      {" "}
      Apart from its panoramic views, A trip to a local beach is a must as
      Portland is famous for its Winifred and Frenchman’s Cove sea views.
      Sitting at the foot of the UNESCO Blue Mountains, a leisurely – or, for
      the more experienced – hearty hike into the area, will reaffirm your
      spirit with its stunning views and a chance to sample and buy the world’s
      best coffee: Jamaica Blue Mountain, from its birthplace. For an additional
      fee, private tours can be arranged once you arrive on-site. And finally,
      let’s not forget the Blue Lagoon. This adds the indescribable wow-factor
      to any visit. With its magical blue waters that change colour during the
      day through to every shade of blue, jade and emerald, going in for a dip
      is a must-do activity before you leave the area.
    </p>{" "}
  </React.Fragment>
);

const fourthRowLeftcolumn = (
  <React.Fragment>
...
const fourthRowRightcolumn = (
  <React.Fragment>
    <SlideShowContainer slideNumber={3}>
      {slideshowTestimonials.map(testimonial => (
        <SlideShowTextSlide {...testimonial} slideNumber={4} />
      ))}
      {/* <SlideShowDots /> */}
    </SlideShowContainer>
  </React.Fragment>
  ...
  render() {
    return (
      ...
      >
        <React.Fragment>
          <TwoColumnRow
            leftcolumn={firstRowLeftcolumn}
            rightcolumn={firstRowRightcolumn}
          />
          <TwoColumnRow
          ...
          />
          <TwoColumnRow
            leftcolumn={thirdRowLeftcolumn}
            rightcolumn={thirdRowRightcolumn}
          />
          <Row>
            <Column> {fourthRowLeftcolumn} </Column>
            <Column>
